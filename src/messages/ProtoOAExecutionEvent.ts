import {
  IProtoOAExecutionEvent as IMessage,
  ProtoOAExecutionEvent as Message,
  IProtoMessage,
  ProtoOAPayloadType
} from "../spotware-messages";
import SpotwareEventEmitter from "../spotware-event-emitter";

export namespace ProtoOAExecutionEvent {
  export const payloadType = ProtoOAPayloadType.PROTO_OA_EXECUTION_EVENT;
  ...
  export function fromProtoMessage(
    ...
    throw new Error(
      `invalid message. expected payloadType 'PROTO_OA_EXECUTION_EVENT' (got '${
