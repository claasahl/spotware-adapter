import {
  IProtoOAUnsubscribeSpotsRes as IMessage,
  ProtoOAUnsubscribeSpotsRes as Message,
  IProtoMessage,
  ProtoOAPayloadType
} from "../spotware-messages";
import SpotwareEventEmitter from "../spotware-event-emitter";

export namespace ProtoOAUnsubscribeSpotsRes {
  export const payloadType = ProtoOAPayloadType.PROTO_OA_UNSUBSCRIBE_SPOTS_RES;
  ...
  export function fromProtoMessage(
    ...
    throw new Error(
      `invalid message. expected payloadType 'PROTO_OA_UNSUBSCRIBE_SPOTS_RES' (got '${
...
export default ProtoOAUnsubscribeSpotsRes;
