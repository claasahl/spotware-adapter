import {
  IProtoOACancelOrderReq as IMessage,
  ProtoOACancelOrderReq as Message,
  IProtoMessage,
  ProtoOAPayloadType
} from "../spotware-messages";
import SpotwareEventEmitter from "../spotware-event-emitter";

export namespace ProtoOACancelOrderReq {
  export const payloadType = ProtoOAPayloadType.PROTO_OA_CANCEL_ORDER_REQ;
  ...
  export function fromProtoMessage(
    ...
    throw new Error(
      `invalid message. expected payloadType 'PROTO_OA_CANCEL_ORDER_REQ' (got '${
