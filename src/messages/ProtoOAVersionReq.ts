import {
  IProtoOAVersionReq as IMessage,
  ProtoOAVersionReq as Message,
  IProtoMessage,
  ProtoOAPayloadType
} from "../spotware-messages";
import SpotwareEventEmitter from "../spotware-event-emitter";

export namespace ProtoOAVersionReq {
  export const payloadType = ProtoOAPayloadType.PROTO_OA_VERSION_REQ;
  ...
  export function fromProtoMessage(
    ...
    throw new Error(
      `invalid message. expected payloadType 'PROTO_OA_VERSION_REQ' (got '${
