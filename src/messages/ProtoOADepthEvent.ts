import {
  IProtoOADepthEvent as IMessage,
  ProtoOADepthEvent as Message,
  IProtoMessage,
  ProtoOAPayloadType
} from "../spotware-messages";
import SpotwareEventEmitter from "../spotware-event-emitter";

export namespace ProtoOADepthEvent {
  export const payloadType = ProtoOAPayloadType.PROTO_OA_DEPTH_EVENT;
  ...
  export function fromProtoMessage(
    ...
    throw new Error(
      `invalid message. expected payloadType 'PROTO_OA_DEPTH_EVENT' (got '${
