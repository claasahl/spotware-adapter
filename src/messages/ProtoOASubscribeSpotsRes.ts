import {
  IProtoOASubscribeSpotsRes as IMessage,
  ProtoOASubscribeSpotsRes as Message,
  IProtoMessage,
  ProtoOAPayloadType
} from "../spotware-messages";
import SpotwareEventEmitter from "../spotware-event-emitter";

export namespace ProtoOASubscribeSpotsRes {
  export const payloadType = ProtoOAPayloadType.PROTO_OA_SUBSCRIBE_SPOTS_RES;
  ...
  export function fromProtoMessage(
    ...
    throw new Error(
      `invalid message. expected payloadType 'PROTO_OA_SUBSCRIBE_SPOTS_RES' (got '${
...
export default ProtoOASubscribeSpotsRes;
