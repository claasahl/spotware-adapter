import {
  IProtoOASymbolCategoryListRes as IMessage,
  ProtoOASymbolCategoryListRes as Message,
  IProtoMessage,
  ProtoOAPayloadType
} from "../spotware-messages";
import SpotwareEventEmitter from "../spotware-event-emitter";

export namespace ProtoOASymbolCategoryListRes {
  export const payloadType = ProtoOAPayloadType.PROTO_OA_SYMBOL_CATEGORY_RES;
  ...
  export function fromProtoMessage(
    ...
    throw new Error(
      `invalid message. expected payloadType 'PROTO_OA_SYMBOL_CATEGORY_RES' (got '${
...
export default ProtoOASymbolCategoryListRes;
