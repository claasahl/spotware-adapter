import {
  IProtoOAErrorRes as IMessage,
  ProtoOAErrorRes as Message,
  IProtoMessage,
  ProtoOAPayloadType
} from "../spotware-messages";
import SpotwareEventEmitter from "../spotware-event-emitter";

export namespace ProtoOAErrorRes {
  export const payloadType = ProtoOAPayloadType.PROTO_OA_ERROR_RES;
  ...
  export function fromProtoMessage(
    ...
    throw new Error(
      `invalid message. expected payloadType 'PROTO_OA_ERROR_RES' (got '${
