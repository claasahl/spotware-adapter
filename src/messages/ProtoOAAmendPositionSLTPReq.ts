import {
  IProtoOAAmendPositionSLTPReq as IMessage,
  ProtoOAAmendPositionSLTPReq as Message,
  IProtoMessage,
  ProtoOAPayloadType
} from "../spotware-messages";
import SpotwareEventEmitter from "../spotware-event-emitter";

export namespace ProtoOAAmendPositionSLTPReq {
  ...
  export function fromProtoMessage(
    ...
    throw new Error(
      `invalid message. expected payloadType 'PROTO_OA_AMEND_POSITION_SLTP_REQ' (got '${
...
export default ProtoOAAmendPositionSLTPReq;
