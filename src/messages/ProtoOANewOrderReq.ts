import {
  IProtoOANewOrderReq as IMessage,
  ProtoOANewOrderReq as Message,
  IProtoMessage,
  ProtoOAPayloadType
} from "../spotware-messages";

export namespace ProtoOANewOrderReq {
  export const payloadType = ProtoOAPayloadType.PROTO_OA_NEW_ORDER_REQ;
  ...
  export function fromProtoMessage(
    ...
    throw new Error(
      `invalid message. expected payloadType 'PROTO_OA_NEW_ORDER_REQ' (got '${
