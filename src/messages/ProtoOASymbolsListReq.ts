import {
  IProtoOASymbolsListReq as IMessage,
  ProtoOASymbolsListReq as Message,
  IProtoMessage,
  ProtoOAPayloadType
} from "../spotware-messages";
import SpotwareEventEmitter from "../spotware-event-emitter";

export namespace ProtoOASymbolsListReq {
  export const payloadType = ProtoOAPayloadType.PROTO_OA_SYMBOLS_LIST_REQ;
  ...
  export function fromProtoMessage(
    ...
    throw new Error(
      `invalid message. expected payloadType 'PROTO_OA_SYMBOLS_LIST_REQ' (got '${
