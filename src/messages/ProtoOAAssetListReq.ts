import {
  IProtoOAAssetListReq as IMessage,
  ProtoOAAssetListReq as Message,
  IProtoMessage,
  ProtoOAPayloadType
} from "../spotware-messages";
import SpotwareEventEmitter from "../spotware-event-emitter";

export namespace ProtoOAAssetListReq {
  export const payloadType = ProtoOAPayloadType.PROTO_OA_ASSET_LIST_REQ;
  ...
  export function fromProtoMessage(
    ...
    throw new Error(
      `invalid message. expected payloadType 'PROTO_OA_ASSET_LIST_REQ' (got '${
