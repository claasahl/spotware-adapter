import {
  IProtoOAGetCtidProfileByTokenReq as IMessage,
  ProtoOAGetCtidProfileByTokenReq as Message,
  IProtoMessage,
  ProtoOAPayloadType
} from "../spotware-messages";

export namespace ProtoOAGetCtidProfileByTokenReq {
  ...
  export function fromProtoMessage(
    ...
    throw new Error(
      `invalid message. expected payloadType 'PROTO_OA_GET_CTID_PROFILE_BY_TOKEN_REQ' (got '${
        ProtoOAPayloadType[payloadType]
      }').`
    );
  }
}
export default ProtoOAGetCtidProfileByTokenReq;
