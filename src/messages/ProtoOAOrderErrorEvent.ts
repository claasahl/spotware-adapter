import {
  IProtoOAOrderErrorEvent as IMessage,
  ProtoOAOrderErrorEvent as Message,
  IProtoMessage,
  ProtoOAPayloadType
} from "../spotware-messages";
import SpotwareEventEmitter from "../spotware-event-emitter";

export namespace ProtoOAOrderErrorEvent {
  export const payloadType = ProtoOAPayloadType.PROTO_OA_ORDER_ERROR_EVENT;
  ...
  export function fromProtoMessage(
    ...
    throw new Error(
      `invalid message. expected payloadType 'PROTO_OA_ORDER_ERROR_EVENT' (got '${
