import {
  IProtoOAGetTickDataRes as IMessage,
  ProtoOAGetTickDataRes as Message,
  IProtoMessage,
  ProtoOAPayloadType
} from "../spotware-messages";
import SpotwareEventEmitter from "../spotware-event-emitter";

export namespace ProtoOAGetTickDataRes {
  export const payloadType = ProtoOAPayloadType.PROTO_OA_GET_TICKDATA_RES;
  ...
  export function fromProtoMessage(
    ...
    throw new Error(
      `invalid message. expected payloadType 'PROTO_OA_GET_TICKDATA_RES' (got '${
