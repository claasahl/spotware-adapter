import {
  IProtoOAClosePositionReq as IMessage,
  ProtoOAClosePositionReq as Message,
  IProtoMessage,
  ProtoOAPayloadType
} from "../spotware-messages";
import SpotwareEventEmitter from "../spotware-event-emitter";

export namespace ProtoOAClosePositionReq {
  export const payloadType = ProtoOAPayloadType.PROTO_OA_CLOSE_POSITION_REQ;
  ...
  export function fromProtoMessage(
    ...
    throw new Error(
      `invalid message. expected payloadType 'PROTO_OA_CLOSE_POSITION_REQ' (got '${
