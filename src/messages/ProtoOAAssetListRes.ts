import {
  IProtoOAAssetListRes as IMessage,
  ProtoOAAssetListRes as Message,
  IProtoMessage,
  ProtoOAPayloadType
} from "../spotware-messages";
import SpotwareEventEmitter from "../spotware-event-emitter";

export namespace ProtoOAAssetListRes {
  export const payloadType = ProtoOAPayloadType.PROTO_OA_ASSET_LIST_RES;
  ...
  export function fromProtoMessage(
    ...
    throw new Error(
      `invalid message. expected payloadType 'PROTO_OA_ASSET_LIST_RES' (got '${
