export { Type as PROTO_MESSAGE } from "./PROTO_MESSAGE";
export { Type as ERROR_RES } from "./ERROR_RES";
export { Type as HEARTBEAT_EVENT } from "./HEARTBEAT_EVENT";
export { Type as PROTO_OA_APPLICATION_AUTH_REQ } from "./PROTO_OA_APPLICATION_AUTH_REQ";
export { Type as PROTO_OA_APPLICATION_AUTH_RES } from "./PROTO_OA_APPLICATION_AUTH_RES";
export { Type as PROTO_OA_ACCOUNT_AUTH_REQ } from "./PROTO_OA_ACCOUNT_AUTH_REQ";
export { Type as PROTO_OA_ACCOUNT_AUTH_RES } from "./PROTO_OA_ACCOUNT_AUTH_RES";
export { Type as PROTO_OA_VERSION_REQ } from "./PROTO_OA_VERSION_REQ";
export { Type as PROTO_OA_VERSION_RES } from "./PROTO_OA_VERSION_RES";
export { Type as PROTO_OA_NEW_ORDER_REQ } from "./PROTO_OA_NEW_ORDER_REQ";
export { Type as PROTO_OA_TRAILING_SL_CHANGED_EVENT } from "./PROTO_OA_TRAILING_SL_CHANGED_EVENT";
export { Type as PROTO_OA_CANCEL_ORDER_REQ } from "./PROTO_OA_CANCEL_ORDER_REQ";
export { Type as PROTO_OA_AMEND_ORDER_REQ } from "./PROTO_OA_AMEND_ORDER_REQ";
export { Type as PROTO_OA_AMEND_POSITION_SLTP_REQ } from "./PROTO_OA_AMEND_POSITION_SLTP_REQ";
export { Type as PROTO_OA_CLOSE_POSITION_REQ } from "./PROTO_OA_CLOSE_POSITION_REQ";
export { Type as PROTO_OA_ASSET_LIST_REQ } from "./PROTO_OA_ASSET_LIST_REQ";
export { Type as PROTO_OA_ASSET_LIST_RES } from "./PROTO_OA_ASSET_LIST_RES";
export { Type as PROTO_OA_SYMBOLS_LIST_REQ } from "./PROTO_OA_SYMBOLS_LIST_REQ";
export { Type as PROTO_OA_SYMBOLS_LIST_RES } from "./PROTO_OA_SYMBOLS_LIST_RES";
export { Type as PROTO_OA_SYMBOL_BY_ID_REQ } from "./PROTO_OA_SYMBOL_BY_ID_REQ";
export { Type as PROTO_OA_SYMBOL_BY_ID_RES } from "./PROTO_OA_SYMBOL_BY_ID_RES";
export { Type as PROTO_OA_SYMBOLS_FOR_CONVERSION_REQ } from "./PROTO_OA_SYMBOLS_FOR_CONVERSION_REQ";
export { Type as PROTO_OA_SYMBOLS_FOR_CONVERSION_RES } from "./PROTO_OA_SYMBOLS_FOR_CONVERSION_RES";
export { Type as PROTO_OA_SYMBOL_CHANGED_EVENT } from "./PROTO_OA_SYMBOL_CHANGED_EVENT";
export { Type as PROTO_OA_TRADER_REQ } from "./PROTO_OA_TRADER_REQ";
export { Type as PROTO_OA_TRADER_RES } from "./PROTO_OA_TRADER_RES";
export { Type as PROTO_OA_TRADER_UPDATE_EVENT } from "./PROTO_OA_TRADER_UPDATE_EVENT";
export { Type as PROTO_OA_RECONCILE_REQ } from "./PROTO_OA_RECONCILE_REQ";
export { Type as PROTO_OA_RECONCILE_RES } from "./PROTO_OA_RECONCILE_RES";
export { Type as PROTO_OA_EXECUTION_EVENT } from "./PROTO_OA_EXECUTION_EVENT";
export { Type as PROTO_OA_SUBSCRIBE_SPOTS_REQ } from "./PROTO_OA_SUBSCRIBE_SPOTS_REQ";
export { Type as PROTO_OA_SUBSCRIBE_SPOTS_RES } from "./PROTO_OA_SUBSCRIBE_SPOTS_RES";
export { Type as PROTO_OA_UNSUBSCRIBE_SPOTS_REQ } from "./PROTO_OA_UNSUBSCRIBE_SPOTS_REQ";
export { Type as PROTO_OA_UNSUBSCRIBE_SPOTS_RES } from "./PROTO_OA_UNSUBSCRIBE_SPOTS_RES";
export { Type as PROTO_OA_SPOT_EVENT } from "./PROTO_OA_SPOT_EVENT";
export { Type as PROTO_OA_ORDER_ERROR_EVENT } from "./PROTO_OA_ORDER_ERROR_EVENT";
export { Type as PROTO_OA_DEAL_LIST_REQ } from "./PROTO_OA_DEAL_LIST_REQ";
export { Type as PROTO_OA_DEAL_LIST_RES } from "./PROTO_OA_DEAL_LIST_RES";
export { Type as PROTO_OA_SUBSCRIBE_LIVE_TRENDBAR_REQ } from "./PROTO_OA_SUBSCRIBE_LIVE_TRENDBAR_REQ";
export { Type as PROTO_OA_UNSUBSCRIBE_LIVE_TRENDBAR_REQ } from "./PROTO_OA_UNSUBSCRIBE_LIVE_TRENDBAR_REQ";
export { Type as PROTO_OA_GET_TRENDBARS_REQ } from "./PROTO_OA_GET_TRENDBARS_REQ";
export { Type as PROTO_OA_GET_TRENDBARS_RES } from "./PROTO_OA_GET_TRENDBARS_RES";
export { Type as PROTO_OA_EXPECTED_MARGIN_REQ } from "./PROTO_OA_EXPECTED_MARGIN_REQ";
export { Type as PROTO_OA_EXPECTED_MARGIN_RES } from "./PROTO_OA_EXPECTED_MARGIN_RES";
export { Type as PROTO_OA_MARGIN_CHANGED_EVENT } from "./PROTO_OA_MARGIN_CHANGED_EVENT";
export { Type as PROTO_OA_ERROR_RES } from "./PROTO_OA_ERROR_RES";
export { Type as PROTO_OA_CASH_FLOW_HISTORY_LIST_REQ } from "./PROTO_OA_CASH_FLOW_HISTORY_LIST_REQ";
export { Type as PROTO_OA_CASH_FLOW_HISTORY_LIST_RES } from "./PROTO_OA_CASH_FLOW_HISTORY_LIST_RES";
export { Type as PROTO_OA_GET_TICKDATA_REQ } from "./PROTO_OA_GET_TICKDATA_REQ";
export { Type as PROTO_OA_GET_TICKDATA_RES } from "./PROTO_OA_GET_TICKDATA_RES";
export { Type as PROTO_OA_ACCOUNTS_TOKEN_INVALIDATED_EVENT } from "./PROTO_OA_ACCOUNTS_TOKEN_INVALIDATED_EVENT";
export { Type as PROTO_OA_CLIENT_DISCONNECT_EVENT } from "./PROTO_OA_CLIENT_DISCONNECT_EVENT";
export { Type as PROTO_OA_GET_ACCOUNTS_BY_ACCESS_TOKEN_REQ } from "./PROTO_OA_GET_ACCOUNTS_BY_ACCESS_TOKEN_REQ";
export { Type as PROTO_OA_GET_ACCOUNTS_BY_ACCESS_TOKEN_RES } from "./PROTO_OA_GET_ACCOUNTS_BY_ACCESS_TOKEN_RES";
export { Type as PROTO_OA_GET_CTID_PROFILE_BY_TOKEN_REQ } from "./PROTO_OA_GET_CTID_PROFILE_BY_TOKEN_REQ";
export { Type as PROTO_OA_GET_CTID_PROFILE_BY_TOKEN_RES } from "./PROTO_OA_GET_CTID_PROFILE_BY_TOKEN_RES";
export { Type as PROTO_OA_ASSET_CLASS_LIST_REQ } from "./PROTO_OA_ASSET_CLASS_LIST_REQ";
export { Type as PROTO_OA_ASSET_CLASS_LIST_RES } from "./PROTO_OA_ASSET_CLASS_LIST_RES";
export { Type as PROTO_OA_DEPTH_EVENT } from "./PROTO_OA_DEPTH_EVENT";
export { Type as PROTO_OA_SUBSCRIBE_DEPTH_QUOTES_REQ } from "./PROTO_OA_SUBSCRIBE_DEPTH_QUOTES_REQ";
export { Type as PROTO_OA_SUBSCRIBE_DEPTH_QUOTES_RES } from "./PROTO_OA_SUBSCRIBE_DEPTH_QUOTES_RES";
export { Type as PROTO_OA_UNSUBSCRIBE_DEPTH_QUOTES_REQ } from "./PROTO_OA_UNSUBSCRIBE_DEPTH_QUOTES_REQ";
export { Type as PROTO_OA_UNSUBSCRIBE_DEPTH_QUOTES_RES } from "./PROTO_OA_UNSUBSCRIBE_DEPTH_QUOTES_RES";
export { Type as PROTO_OA_SYMBOL_CATEGORY_REQ } from "./PROTO_OA_SYMBOL_CATEGORY_REQ";
export { Type as PROTO_OA_SYMBOL_CATEGORY_RES } from "./PROTO_OA_SYMBOL_CATEGORY_RES";
export { Type as PROTO_OA_ACCOUNT_LOGOUT_REQ } from "./PROTO_OA_ACCOUNT_LOGOUT_REQ";
export { Type as PROTO_OA_ACCOUNT_LOGOUT_RES } from "./PROTO_OA_ACCOUNT_LOGOUT_RES";
export { Type as PROTO_OA_ACCOUNT_DISCONNECT_EVENT } from "./PROTO_OA_ACCOUNT_DISCONNECT_EVENT";
export { Type as PROTO_OA_SUBSCRIBE_LIVE_TRENDBAR_RES } from "./PROTO_OA_SUBSCRIBE_LIVE_TRENDBAR_RES";
export { Type as PROTO_OA_UNSUBSCRIBE_LIVE_TRENDBAR_RES } from "./PROTO_OA_UNSUBSCRIBE_LIVE_TRENDBAR_RES";
export { Type as PROTO_OA_MARGIN_CALL_LIST_REQ } from "./PROTO_OA_MARGIN_CALL_LIST_REQ";
export { Type as PROTO_OA_MARGIN_CALL_LIST_RES } from "./PROTO_OA_MARGIN_CALL_LIST_RES";
export { Type as PROTO_OA_MARGIN_CALL_UPDATE_REQ } from "./PROTO_OA_MARGIN_CALL_UPDATE_REQ";
export { Type as PROTO_OA_MARGIN_CALL_UPDATE_RES } from "./PROTO_OA_MARGIN_CALL_UPDATE_RES";
export { Type as PROTO_OA_MARGIN_CALL_UPDATE_EVENT } from "./PROTO_OA_MARGIN_CALL_UPDATE_EVENT";
export { Type as PROTO_OA_MARGIN_CALL_TRIGGER_EVENT } from "./PROTO_OA_MARGIN_CALL_TRIGGER_EVENT";
export { Type as PROTO_OA_REFRESH_TOKEN_REQ } from "./PROTO_OA_REFRESH_TOKEN_REQ";
export { Type as PROTO_OA_REFRESH_TOKEN_RES } from "./PROTO_OA_REFRESH_TOKEN_RES";
export { Type as PROTO_OA_ORDER_LIST_REQ } from "./PROTO_OA_ORDER_LIST_REQ";
export { Type as PROTO_OA_ORDER_LIST_RES } from "./PROTO_OA_ORDER_LIST_RES";
export { Type as PROTO_OA_GET_DYNAMIC_LEVERAGE_REQ } from "./PROTO_OA_GET_DYNAMIC_LEVERAGE_REQ";
export { Type as PROTO_OA_GET_DYNAMIC_LEVERAGE_RES } from "./PROTO_OA_GET_DYNAMIC_LEVERAGE_RES";
export { Type as PROTO_OA_DEAL_LIST_BY_POSITION_ID_REQ } from "./PROTO_OA_DEAL_LIST_BY_POSITION_ID_REQ";
export { Type as PROTO_OA_DEAL_LIST_BY_POSITION_ID_RES } from "./PROTO_OA_DEAL_LIST_BY_POSITION_ID_RES";
export { Type as PROTO_OA_ORDER_DETAILS_REQ } from "./PROTO_OA_ORDER_DETAILS_REQ";
export { Type as PROTO_OA_ORDER_DETAILS_RES } from "./PROTO_OA_ORDER_DETAILS_RES";
export { Type as PROTO_OA_ORDER_LIST_BY_POSITION_ID_REQ } from "./PROTO_OA_ORDER_LIST_BY_POSITION_ID_REQ";
export { Type as PROTO_OA_ORDER_LIST_BY_POSITION_ID_RES } from "./PROTO_OA_ORDER_LIST_BY_POSITION_ID_RES";
export { Type as PROTO_OA_DEAL_OFFSET_LIST_REQ } from "./PROTO_OA_DEAL_OFFSET_LIST_REQ";
export { Type as PROTO_OA_DEAL_OFFSET_LIST_RES } from "./PROTO_OA_DEAL_OFFSET_LIST_RES";
export { Type as PROTO_OA_GET_POSITION_UNREALIZED_PNL_REQ } from "./PROTO_OA_GET_POSITION_UNREALIZED_PNL_REQ";
export { Type as PROTO_OA_GET_POSITION_UNREALIZED_PNL_RES } from "./PROTO_OA_GET_POSITION_UNREALIZED_PNL_RES";
export { Type as PROTO_OA_V1_PNL_CHANGE_EVENT } from "./PROTO_OA_V1_PNL_CHANGE_EVENT";
export { Type as PROTO_OA_V1_PNL_CHANGE_SUBSCRIBE_REQ } from "./PROTO_OA_V1_PNL_CHANGE_SUBSCRIBE_REQ";
export { Type as PROTO_OA_V1_PNL_CHANGE_SUBSCRIBE_RES } from "./PROTO_OA_V1_PNL_CHANGE_SUBSCRIBE_RES";
export { Type as PROTO_OA_V1_PNL_CHANGE_UN_SUBSCRIBE_REQ } from "./PROTO_OA_V1_PNL_CHANGE_UN_SUBSCRIBE_REQ";
export { Type as PROTO_OA_V1_PNL_CHANGE_UN_SUBSCRIBE_RES } from "./PROTO_OA_V1_PNL_CHANGE_UN_SUBSCRIBE_RES";
...
import * as PROTO_OA_ORDER_LIST_REQ from "./PROTO_OA_ORDER_LIST_REQ";
import * as PROTO_OA_ORDER_LIST_RES from "./PROTO_OA_ORDER_LIST_RES";
import * as PROTO_OA_GET_DYNAMIC_LEVERAGE_REQ from "./PROTO_OA_GET_DYNAMIC_LEVERAGE_REQ";
import * as PROTO_OA_GET_DYNAMIC_LEVERAGE_RES from "./PROTO_OA_GET_DYNAMIC_LEVERAGE_RES";
import * as PROTO_OA_DEAL_LIST_BY_POSITION_ID_REQ from "./PROTO_OA_DEAL_LIST_BY_POSITION_ID_REQ";
import * as PROTO_OA_DEAL_LIST_BY_POSITION_ID_RES from "./PROTO_OA_DEAL_LIST_BY_POSITION_ID_RES";
import * as PROTO_OA_ORDER_DETAILS_REQ from "./PROTO_OA_ORDER_DETAILS_REQ";
import * as PROTO_OA_ORDER_DETAILS_RES from "./PROTO_OA_ORDER_DETAILS_RES";
import * as PROTO_OA_ORDER_LIST_BY_POSITION_ID_REQ from "./PROTO_OA_ORDER_LIST_BY_POSITION_ID_REQ";
import * as PROTO_OA_ORDER_LIST_BY_POSITION_ID_RES from "./PROTO_OA_ORDER_LIST_BY_POSITION_ID_RES";
import * as PROTO_OA_DEAL_OFFSET_LIST_REQ from "./PROTO_OA_DEAL_OFFSET_LIST_REQ";
import * as PROTO_OA_DEAL_OFFSET_LIST_RES from "./PROTO_OA_DEAL_OFFSET_LIST_RES";
import * as PROTO_OA_GET_POSITION_UNREALIZED_PNL_REQ from "./PROTO_OA_GET_POSITION_UNREALIZED_PNL_REQ";
import * as PROTO_OA_GET_POSITION_UNREALIZED_PNL_RES from "./PROTO_OA_GET_POSITION_UNREALIZED_PNL_RES";
import * as PROTO_OA_V1_PNL_CHANGE_EVENT from "./PROTO_OA_V1_PNL_CHANGE_EVENT";
import * as PROTO_OA_V1_PNL_CHANGE_SUBSCRIBE_REQ from "./PROTO_OA_V1_PNL_CHANGE_SUBSCRIBE_REQ";
import * as PROTO_OA_V1_PNL_CHANGE_SUBSCRIBE_RES from "./PROTO_OA_V1_PNL_CHANGE_SUBSCRIBE_RES";
import * as PROTO_OA_V1_PNL_CHANGE_UN_SUBSCRIBE_REQ from "./PROTO_OA_V1_PNL_CHANGE_UN_SUBSCRIBE_REQ";
import * as PROTO_OA_V1_PNL_CHANGE_UN_SUBSCRIBE_RES from "./PROTO_OA_V1_PNL_CHANGE_UN_SUBSCRIBE_RES";
...
export type Messages =
  ...
  | PROTO_OA_ORDER_LIST_REQ.Type
  | PROTO_OA_ORDER_LIST_RES.Type
  | PROTO_OA_GET_DYNAMIC_LEVERAGE_REQ.Type
  | PROTO_OA_GET_DYNAMIC_LEVERAGE_RES.Type
  | PROTO_OA_DEAL_LIST_BY_POSITION_ID_REQ.Type
  | PROTO_OA_DEAL_LIST_BY_POSITION_ID_RES.Type
  | PROTO_OA_ORDER_DETAILS_REQ.Type
  | PROTO_OA_ORDER_DETAILS_RES.Type
  | PROTO_OA_ORDER_LIST_BY_POSITION_ID_REQ.Type
  | PROTO_OA_ORDER_LIST_BY_POSITION_ID_RES.Type
  | PROTO_OA_DEAL_OFFSET_LIST_REQ.Type
  | PROTO_OA_DEAL_OFFSET_LIST_RES.Type
  | PROTO_OA_GET_POSITION_UNREALIZED_PNL_REQ.Type
  | PROTO_OA_GET_POSITION_UNREALIZED_PNL_RES.Type
  | PROTO_OA_V1_PNL_CHANGE_EVENT.Type
  | PROTO_OA_V1_PNL_CHANGE_SUBSCRIBE_REQ.Type
  | PROTO_OA_V1_PNL_CHANGE_SUBSCRIBE_RES.Type
  | PROTO_OA_V1_PNL_CHANGE_UN_SUBSCRIBE_REQ.Type
  | PROTO_OA_V1_PNL_CHANGE_UN_SUBSCRIBE_RES.Type;
...
export const FACTORY = {
  ...
  PROTO_OA_ORDER_LIST_REQ: PROTO_OA_ORDER_LIST_REQ.create,
  PROTO_OA_ORDER_LIST_RES: PROTO_OA_ORDER_LIST_RES.create,
  PROTO_OA_GET_DYNAMIC_LEVERAGE_REQ: PROTO_OA_GET_DYNAMIC_LEVERAGE_REQ.create,
  PROTO_OA_GET_DYNAMIC_LEVERAGE_RES: PROTO_OA_GET_DYNAMIC_LEVERAGE_RES.create,
  PROTO_OA_DEAL_LIST_BY_POSITION_ID_REQ:
    PROTO_OA_DEAL_LIST_BY_POSITION_ID_REQ.create,
  PROTO_OA_DEAL_LIST_BY_POSITION_ID_RES:
    PROTO_OA_DEAL_LIST_BY_POSITION_ID_RES.create,
  PROTO_OA_ORDER_DETAILS_REQ: PROTO_OA_ORDER_DETAILS_REQ.create,
  PROTO_OA_ORDER_DETAILS_RES: PROTO_OA_ORDER_DETAILS_RES.create,
  PROTO_OA_ORDER_LIST_BY_POSITION_ID_REQ:
    PROTO_OA_ORDER_LIST_BY_POSITION_ID_REQ.create,
  PROTO_OA_ORDER_LIST_BY_POSITION_ID_RES:
    PROTO_OA_ORDER_LIST_BY_POSITION_ID_RES.create,
  PROTO_OA_DEAL_OFFSET_LIST_REQ: PROTO_OA_DEAL_OFFSET_LIST_REQ.create,
  PROTO_OA_DEAL_OFFSET_LIST_RES: PROTO_OA_DEAL_OFFSET_LIST_RES.create,
  PROTO_OA_GET_POSITION_UNREALIZED_PNL_REQ:
    PROTO_OA_GET_POSITION_UNREALIZED_PNL_REQ.create,
  PROTO_OA_GET_POSITION_UNREALIZED_PNL_RES:
    PROTO_OA_GET_POSITION_UNREALIZED_PNL_RES.create,
  PROTO_OA_V1_PNL_CHANGE_EVENT: PROTO_OA_V1_PNL_CHANGE_EVENT.create,
  PROTO_OA_V1_PNL_CHANGE_SUBSCRIBE_REQ:
    PROTO_OA_V1_PNL_CHANGE_SUBSCRIBE_REQ.create,
  PROTO_OA_V1_PNL_CHANGE_SUBSCRIBE_RES:
    PROTO_OA_V1_PNL_CHANGE_SUBSCRIBE_RES.create,
  PROTO_OA_V1_PNL_CHANGE_UN_SUBSCRIBE_REQ:
    PROTO_OA_V1_PNL_CHANGE_UN_SUBSCRIBE_REQ.create,
  PROTO_OA_V1_PNL_CHANGE_UN_SUBSCRIBE_RES:
    PROTO_OA_V1_PNL_CHANGE_UN_SUBSCRIBE_RES.create,
};
