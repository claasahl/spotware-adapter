import {
  IProtoOASymbolsForConversionRes as IMessage,
  ProtoOASymbolsForConversionRes as Message,
  IProtoMessage,
  ProtoOAPayloadType
} from "../spotware-messages";
import SpotwareEventEmitter from "../spotware-event-emitter";

export namespace ProtoOASymbolsForConversionRes {
  ...
  export function fromProtoMessage(
    ...
    throw new Error(
      `invalid message. expected payloadType 'PROTO_OA_SYMBOLS_FOR_CONVERSION_RES' (got '${
...
export default ProtoOASymbolsForConversionRes;
