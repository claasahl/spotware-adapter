...
export class FromSpotware extends Transform {
  ...
  _transform(
    ...
    if (encoding !== "binary") {
      return callback(new Error(`encoding must be binary. got: ${encoding}`));
    }
    ...
    switch (message.payloadType) {
      ...
      case 2101:
        ...
        break;
      case 2102:
        msg.payload = $.ProtoOAAccountAuthReqUtils.read(
          new Pbf(message.payload)
        );
        break;
      case 2103:
        msg.payload = $.ProtoOAAccountAuthResUtils.read(
          new Pbf(message.payload)
        );
        break;
      case 2104:
      ...
      case 2107:
        ...
        break;
      case 2108:
        msg.payload = $.ProtoOACancelOrderReqUtils.read(
          new Pbf(message.payload)
        );
        break;
      case 2109:
        msg.payload = $.ProtoOAAmendOrderReqUtils.read(
          new Pbf(message.payload)
        );
        break;
      case 2110:
      ...
      case 2113:
        ...
        break;
      case 2114:
        msg.payload = $.ProtoOASymbolsListReqUtils.read(
          new Pbf(message.payload)
        );
        break;
      case 2115:
        msg.payload = $.ProtoOASymbolsListResUtils.read(
          new Pbf(message.payload)
        );
        break;
      case 2116:
        msg.payload = $.ProtoOASymbolByIdReqUtils.read(
          new Pbf(message.payload)
        );
        break;
      case 2117:
        msg.payload = $.ProtoOASymbolByIdResUtils.read(
          new Pbf(message.payload)
        );
        break;
      case 2118:
      ...
      case 2125:
        ...
        break;
      case 2126:
        msg.payload = $.ProtoOAExecutionEventUtils.read(
          new Pbf(message.payload)
        );
        break;
      case 2127:
      ...
      case 2144:
        ...
        break;
      case 2145:
        msg.payload = $.ProtoOAGetTickDataReqUtils.read(
          new Pbf(message.payload)
        );
        break;
      case 2146:
        msg.payload = $.ProtoOAGetTickDataResUtils.read(
          new Pbf(message.payload)
        );
        break;
      case 2147:
...
export class ToSpotware extends Transform {
  constructor() {
    super({
      allowHalfOpen: false,
